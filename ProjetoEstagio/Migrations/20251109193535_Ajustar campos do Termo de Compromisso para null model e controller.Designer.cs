...
namespace ProjetoEstagio.Migrations
{
    ...
    [Migration("20251109193535_Ajustar campos do Termo de Compromisso para null model e controller")]
    partial class AjustarcamposdoTermodeCompromissoparanullmodelecontroller
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjetoEstagio.Models.TermoCompromissoModel", b =>
                {
                    ...
                    b.HasOne("ProjetoEstagio.Models.SolicitacaoEstagioModel", "SolicitacaoEstagio")
                        .WithMany()
                        .HasForeignKey("SolicitacaoEstagioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
