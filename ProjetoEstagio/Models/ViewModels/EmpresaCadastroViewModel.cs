...
namespace ProjetoEstagio.Models.ViewModels
{
    public class EmpresaCadastroViewModel
    {
        ...
        [Required(ErrorMessage = "O CNPJ é obrigatório.(ViewModel)")]
        ...
        [Required(ErrorMessage = "O Telefone é obrigatório.(ViewModel)")]
        public string Telefone { get; set; }

        [Required(ErrorMessage = "O E-mail é obrigatório.")]
        [EmailAddress(ErrorMessage = "E-mail inválido.")]
        [Remote(action: "VerificarEmailUnico", controller: "Empresa", ErrorMessage = "Este E-mail já está cadastrado.")]
