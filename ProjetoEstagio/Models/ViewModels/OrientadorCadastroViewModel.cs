// Models/ViewModels/OrientadorCadastroViewModel.cs
...
{
    public class OrientadorCadastroViewModel
    {
        [Required(ErrorMessage = "O nome é obrigatório.")]
        public string Nome { get; set; }

        [Required(ErrorMessage = "O CPF é obrigatório.")]
        [Remote(action: "VerificarCPFUnico", controller: "Orientador", ErrorMessage = "Este CPF já está cadastrado.")]
